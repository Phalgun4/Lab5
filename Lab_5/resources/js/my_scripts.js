...
function switchPlayers(playerNum)
{
	...
	var p_img = players[playerNum]["img"]
	document.getElementById("player_img").src=p_img

	var p_alt = players[playerNum]["img"]
	document.getElementById("player_img").alt=p_alt
	// var p_alt=players[playerNum]["alt"]
	// document.getElementById("Placeholder for football player image - Football Helmet").alt=p_alt
